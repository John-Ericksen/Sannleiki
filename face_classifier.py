...
face_data_generator = ImageDataGenerator(preprocessing_function=vgg19.preprocess_input
)
...
vgg16FaceModel.add(vgg19.VGG19(
    include_top=False,
    pooling='avg',
    weights='imagenet',
    ))
...
vgg16FaceModel.save('face_classifier_vgg19.h5')